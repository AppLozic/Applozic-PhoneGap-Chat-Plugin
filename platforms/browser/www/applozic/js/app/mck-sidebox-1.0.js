...
(function($applozic, w, d) {
    ...
    function Applozic(appOptions) {
        ...
        var alMediaService = new ALMediaService();
        ...
        _this.loadTab = function(tabId) {
            ...
            $applozic('#mck-search').val('');
            mckMessageService.changeKeyboardState(false);
        };
        ...
        _this.uploadFile = function(params) {
            mckFileService.uploadFile(params); 
        };
        ...
        function MckMessageService() {
            ...
            _this.changeKeyboardState = function(opened) {
                _this.keyboardOpened = opened;
            }
            _this.init = function() {
                mckStorage.clearMckMessageArray();
                ...
                $applozic(d).on('click', '.mck-box-body', function(e) {
                    if (event.target.id == "mck-text-box" || event.target.id == "mck-contact-search-input" || $applozic(event.target).hasClass("applozic-launcher")) {
                        console.log("returning");
                        return;
                    }
                    if (_this.keyboardOpened) {
                        $("#mck-sidebox").removeClass('in');
                        setTimeout(function () {
                          $("#mck-sidebox").addClass('in');
                        }, 600);
                   }
                    _this.keyboardOpened = false;
                });

                $("input").focus(function(event) {
                    _this.keyboardOpened = true;
                });
        ...
        function MckMessageLayout() {
            ...
            _this.addMessage = function(msg, contact, append, scroll, appendContextMenu) {
                ...
                /* Todo: enable it once download icon UI is aligned
                if (typeof msg.fileMeta === "object") {
        ...
        function ALMediaService() {
            ...
            _this.init = function() {
                _this.$micRecorder = $applozic("#al-mic-btn");
                $applozic('#mck-sidebox').on("click", "#al-mic-btn" ,function() {
                    //this.disabled = true;
            ...
            _this.startRecording = function() { 
                //Todo: replace it with generated name based on timestamp.
               /* var src = "FinalAudio4.wav"; 
                _this.myMedia = new Media(src, _this.onSuccess, _this.onError); 
           ...
           /* _this.onSuccess = function() { 
            ...
            function captureSuccess(mediaFiles) {
                ...
                for (i = 0, len = mediaFiles.length; i < len; i += 1) {
                    ...
                    //Todo: create file from media full path
                    ...
                    window.resolveLocalFileSystemURL(mediaFile.fullPath, function (fileEntry) {
                        ...
                        }, errorHandler.bind(null, mediaFile.name));
                    }, errorHandler.bind(null, mediaFile.name));
